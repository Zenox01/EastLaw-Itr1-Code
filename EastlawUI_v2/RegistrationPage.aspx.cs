    ...
    public partial class RegistrationPage : System.Web.UI.Page
    {
        ...
        void GetOrgTypes()
        {
            try
            {
                ...
                ddlOrgType.Items.Insert(0, new ListItem("Select Organization Type", "0"));
            }
            catch (Exception ex)
            {
        ...
        void GetPracticeArea()
        {
            try
            {
                ...
                chkPracticeArea.DataTextField = "PracticeAreaCatName";
        ...
        void SaveRecord()
        {
            try
            {
                ...
                if (chk > 0)
                {
                    ...
                    //Email.SendMail("adilsiddiqui131@gmail.com", AdminEmailContent(), "Welcome to eastlaw.pk", "EastLaw", "");
                    ...
                    //Email.SendMail("info@eastlaw.pk", AdminEmailContent(), "Welcome to eastlaw.pk", "EastLaw", "");
        ...
        string EmailContent(int ID)
        {
            try
            {
                ...
                html = html.Replace("##FullName##", txtFName.Text.Trim() + " " + txtLName.Text.Trim());
        ...
        string AdminEmailContent()
        {
            try
            {
                ...
                for (int a = 0; a < chkPracticeArea.Items.Count; a++)
                {
                    if (chkPracticeArea.Items[a].Selected == true)
                    {
                        strPracticeArea = strPracticeArea+", "+ chkPracticeArea.Items[a].Text;
                    }
                }
                ...
                html = html.Replace("##Organization##", txtOrgName.Text);
                html = html.Replace("##OrganizationType##", ddlOrgType.SelectedItem.Text);
                html = html.Replace("##Country##", ddlCountry.SelectedItem.Text);
                html = html.Replace("##City##", ddlCity.SelectedItem.Text);
                html = html.Replace("##Address##", txtPostalAddress.Text);
                html = html.Replace("##PracticeArea##", strPracticeArea);
                // html = html.Replace("##Pwd##", Session["Pwd"].ToString());
        ...
        void SendWelcomeSMS(int ID)
        {
            try
            {
                string smstxt = "Dear " + txtFName.Text.Trim() + " " + txtLName.Text.Trim() + ", Thank you for Registering at EastLaw.pk."
                + "Please check your email to activate your account or Click " + ConfigurationSettings.AppSettings["websiteUrl"].ToString() + "member/member-activation?uval=" + EncryptDecryptHelper.Encrypt(ID.ToString()) + " to activate it now.  Helpline#. 0304-1116670";
