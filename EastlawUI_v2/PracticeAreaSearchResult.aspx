<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PracticeAreaSearchResult.aspx.cs" Inherits="EastlawUI_v2.PracticeAreaSearchResult"
...
<div class="row breadcrum">
     ...
     <ul class="bc">
        ...
        <% } else { %>
        <li><a href="/"> Home</a></li><a href="PracticeAreaSearchResult.aspx">PracticeAreaSearchResult.aspx</a>
        <%} %>
                    <%--<li><a href="/practice-Area"> Practice Area Home</a></li>--%>
                    <li><asp:HyperLink ID="hypLnkItems" runat="server"></asp:HyperLink> </li>
                    <li><asp:Label ID="lblCurCrumb" runat="server" class="current"></asp:Label></li>
                </ul>
   ...
   <div class="heading_style">
            	...
            	<h3>Seach Result of <i style="color:#c4161c;"><asp:Label ID="lblSearchWords" runat="server" ForeColor="#D11515"></asp:Label></i></h3>
        ...
        <br />
          ...
          <div id="divResult" runat="server">
              ...
              <asp:GridView ID="gvLst" runat="server" AutoGenerateColumns="false" Width="100%" CssClass="table table-filter"
                     GridLines="None" AllowPaging="true" AllowCustomPaging="true" PageSize="20" OnPageIndexChanging="gvLst_PageIndexChanging" OnRowDataBound="gvLst_RowDataBound">
                            ...
                            <ItemTemplate>
                                <div class="media">
												...
												<div class="media-body">
													...
													<a href='<%# Eval("Link") %>'><h4 class="title">
														<%# Eval("Title") %> <span class="pull-right">[ <%# Eval("Court") %> ]  </span>
                                                    ...
                                                    <div class="col-lg-7 col-md-7" style="padding-left:0;">
                                                    <p class="pull-left"><strong>Appeal : </strong> <%# Eval("Appeal") %></p>
                                                    </div>
                                                    <div class="col-lg-5 col-md-5">
                                                    ...
                                                    <div class="row">
                                                    	...
                                                    	<button type="button" class="btn_show" data-toggle="collapse" data-target='<%# "#demo"+Eval("ID") %>' runat="server" id="btnshowsumary">Show Case Summary</button>
