<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managecourtappealmastr.aspx.cs" 
    Inherits="EastlawUI_v2.adminpanel.managecourtappealmastr" MasterPageFile="~/adminpanel/Site1.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cntplc">
    <%--    <asp:UpdatePanel ID="updPnl" runat="server">
      ...
      <section class="content-header">
                    <h1>
                        Courts
                        <small>Courts Appeal Master</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Manage Courts Appeal Master</li>
                    </ol>
                </section>
    ...
    <section class="content">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Courts Appeal Master List</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
        ...
        <Columns> 
            ...
            <asp:TemplateField HeaderText="Appeal Type" HeaderStyle-HorizontalAlign="Left"> 
                <EditItemTemplate> 
                    <asp:TextBox ID="txtEditCourtAppealName" runat="server" Text='<%# Bind("Crt_appl_mstr") %>'></asp:TextBox> 
                ...
                <ItemTemplate> 
                    <asp:Label ID="lblCourtAppealName" runat="server" Text='<%# Bind("Crt_appl_mstr") %>'></asp:Label> 
                </ItemTemplate> 
            </asp:TemplateField> 
