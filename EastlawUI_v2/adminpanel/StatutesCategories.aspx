<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatutesCategories.aspx.cs" Inherits="EastlawUI_v2.adminpanel.StatutesCategories"
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cntplc">
    <asp:UpdatePanel ID="updPnl" runat="server">
      ...
      <section class="content-header">
                    <h1>
                        Statutes
                        <small>Statutes Categories List</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Statutes Categories</li>
                    </ol>
                </section>
    ...
    <section class="content">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Statutes Categories List</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
        ...
        <Columns> 
            ...
            <asp:TemplateField HeaderText="Keyword" HeaderStyle-HorizontalAlign="Left"> 
                <EditItemTemplate> 
                    <asp:TextBox ID="txtEditCat" runat="server" Text='<%# Bind("CatWithCount") %>'></asp:TextBox> 
