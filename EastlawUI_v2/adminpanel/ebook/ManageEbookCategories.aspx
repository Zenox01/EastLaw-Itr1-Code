<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageEbookCategories.aspx.cs" Inherits="EastlawUI_v2.adminpanel.ebook.ManageEbookCategories" 
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="cntplc">
    <asp:UpdatePanel ID="updPnl" runat="server">
      ...
      <section class="content-header">
                    <h1>
                        E-Book & Statutes
                        <small>E-Book & Statutes Categories</small>
                    </h1>
    ...
    <section class="content">
        ...
        <Columns> 
            ...
            <asp:TemplateField HeaderText="EBook Cat" HeaderStyle-HorizontalAlign="Left"> 
                <EditItemTemplate> 
                    <asp:TextBox ID="txtEditCat" runat="server" Text='<%# Bind("EBookCat") %>'></asp:TextBox> 
                ...
                <ItemTemplate> 
                    <asp:Label ID="lblName" runat="server" Text='<%# Bind("EBookCat") %>'></asp:Label> 
                </ItemTemplate> 
            </asp:TemplateField> 
