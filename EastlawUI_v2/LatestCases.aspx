<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LatestCases.aspx.cs" Inherits="EastlawUI_v2.LatestCases" 
...
<ul class="bc">
    ...
    <li><a href="#" class="current">Cases</a></li>
  ...
  <div class="panel-group wrap" id="accordion" role="tablist" aria-multiselectable="true">
      ...
      <div class="panel">
        ...
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
         <i class="fa fa-calendar" aria-hidden="true" style="display:inline-block;"></i><p class="sr_head">Months</p>
        </a>
      </h4>
        </div>
