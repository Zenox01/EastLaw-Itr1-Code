<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PracticeAreaSearchResult.aspx.cs" Inherits="EastlawUI_v2.m.PracticeAreaSearchResult" 
                                    ...
                                    <article class="ac-small">
                                        ...
                                        <%--<ul>
                                            <li>
                                                ...
                                                <strong>Additional Secretay, Government of Pakistan(1)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Administrative Tribunal(1)</strong>                                            </li>
                                            
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Bench Competition Commission of Pakistan(2)                </strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Bench Of Security & Exchange Commission(121)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Jurisdiction(48)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Tribunal(1)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Tribunal Anti-Terrorism(2)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Tribunal Inland Revenue(330)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Tribunal Revenue (Islamabad)(1)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Appellate Tribunal Pakistan(3)</strong>                                            </li>
                                            <li>
                                                <span><input name="" type="checkbox" value=""></span> 
                                                <strong>Authority Under Payment Of Wages Act(3)</strong>                                            </li>
                                            <li>
