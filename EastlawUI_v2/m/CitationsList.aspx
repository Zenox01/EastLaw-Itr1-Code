<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CitationsList.aspx.cs" Inherits="EastlawUI_v2.m.CitationsList"
    	...
    	<div class="container">
                ...
                <div class="RowFilter">
                    ...
                    <div class="rgt" id="spanMyFolder" runat="server">
                        ...
                        <span style="display:none">
                        	Parent Folder *
                                <asp:RequiredFieldValidator ID="rfvParentFolder" ValidationGroup="CreateFolder" runat="server" ErrorMessage="Required" ForeColor="Red" Enabled="false" ControlToValidate="ddlParentFolder"></asp:RequiredFieldValidator>&nbsp;</label><%--<input type="text" value="" />
                             ...
                             <div class="lftBlock">
                                <div>
                                    ...
                                    <article class="ac-small">
                                        <asp:CheckBoxList ID="chkContentType" runat="server"  AutoPostBack="true" ></asp:CheckBoxList>
            ...
            position="TopAndBottom" />
                    ...
                    <Columns>
                        ...
                        <h6> <strong><a href='<%# Eval("Link") %>'><span style="text-transform:capitalize"> <%# Eval("Title") %></span></a></strong><br /><br />
                        <strong>Where Reported:</strong><%# Eval("Citation") %><br />
                        <strong>Date:</strong><%# Eval("JDate") %><br /><strong>Court:</strong> <%# Eval("Court") %> <br /> 
                    <strong>Appeal:</strong>  <%# Eval("Appeal") %><br />
                     <strong>Keywords:</strong>  <%# Eval("Keywords") %><br /><br />
                        <%#(String.IsNullOrEmpty(Eval("Statutes").ToString()) ? "0" : Eval("Statutes"))%>
                        

                    	
                      
                        <div class="result">
                             <%# ((string)Eval("ShortDes")).Replace("</p>", "").Replace("<p>","").Replace("<br>","").Replace("<b>","").Replace("</b>","")%>
