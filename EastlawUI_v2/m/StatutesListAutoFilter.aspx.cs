        ...
        void FilterResults()
        {
            try
            {
                ...
                for (int a = 0; a < chkCat.Items.Count; a++)
                {
                    ...
                    {
                        Statutes_Category_SubGroup = Statutes_Category_SubGroup + "'" + chkCat.Items[a].Value + "'" + ",";
                    }
                }
                ...
                {
                    Statutes_Category_SubGroup = Statutes_Category_SubGroup.Remove(cat.Length - 1);
