...
{
    public partial class CasesAdvanceSearch : System.Web.UI.Page
    {
        ...
        void GetCourts()
        {
            try
            {
                ...
                ddlPartyCourt.DataValueField = "court";
                ddlPartyCourt.DataTextField = "court";
                ddlPartyCourt.DataSource = dt;
                ddlPartyCourt.DataBind();
                ddlPartyCourt.Items.Insert(0, new ListItem("Select", "0"));
            }
            catch { }
        }
        ...
        protected void btnSearchFreetext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strSearch[1] = "Cases";
                Response.Redirect("/m/Search/" + txtFreeText.Text.Trim());
                // }
        ...
        //        cri = cri + " AND  A.Appeallant='" + txtPartyNames.Text + "'";
        ...
        void CitationsSearch()
        {
            try
            {
                ...
                //if (!string.IsNullOrEmpty(courts) && (string.IsNullOrEmpty(txtFreeText.Text.Trim()) && string.IsNullOrEmpty(txtKeyword.Text.Trim()) && string.IsNullOrEmpty(txtAppeallant.Text.Trim()) && string.IsNullOrEmpty(txtRespondent.Text.Trim())))
                //{
                //    lblCaseAdvanceMsg.Text = "Please enter other terms with court.";
        ...
        void CitationsSearchPartyName()
        {
            try
            {
                ...
                {
                    forlog = forlog + " Freetext: " + txtFreeText.Text;
                    cri = cri + " AND A.Appeallant like '%" + txtPartyNames.Text.Trim() + "%' or A.Respondent like '%" + txtPartyNames.Text.Trim() + "%' ";
                }
        ...
        protected void btnSearchexactphrase_Click(object sender, EventArgs e)
        {
            try
            {
                string forlog = "";
                if (!string.IsNullOrEmpty(txtSearchexactphrase.Text.Trim()))
                {
                    forlog = forlog + " Freetext: " + txtSearchexactphrase.Text;
                    
                    InsertAuditLog("Search", "Case Advance Search", forlog);
                    string[] strSearch = new string[5];
                    strSearch[0] = "Cases";
                    Session["MemberSearchPara"] = strSearch;
                    Response.Redirect("/m/Search/" + "\"" + txtSearchexactphrase.Text + "\"");
                }
            }
            catch { }
        }
        ...
        protected void btnExactPhraseMore_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(txtExactPhraseMore.Text.Trim()) && !string.IsNullOrEmpty(txtExactPhraseMore2.Text.Trim()))
                {
                    ...
                    strSearch[0] = "Cases";
                    Session["MemberSearchPara"] = strSearch;
                    Response.Redirect("/m/Search/" + keywordtxt);
                }
            }
            catch { }
        }

        protected void btnMultipleKeywords_Click(object sender, EventArgs e)
        {
