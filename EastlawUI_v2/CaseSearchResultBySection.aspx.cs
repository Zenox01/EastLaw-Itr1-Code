...
{
    public partial class CaseSearchResultBySection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                InsertAuditLog("Search", "Case Search By Section", "Result");
                BindSearchResult();
        ...
        void BindSearchResult()
        {
            try
            {
                if (Session["CasesSectionSearch"] != null)
                {


                    DataTable dt = new DataTable();
                    dt = (DataTable)Session["CasesSectionSearch"];
        ...
        void SearchWithin(string SearchWithin)
        {
            try
            {
                ...
                DataTable dt = (DataTable)Session["CasesSectionSearch"];
        ...
        void FilterResults()
        {
            try
            {
                ...
                dtFilter = (DataTable)Session["CasesSectionSearch"];
