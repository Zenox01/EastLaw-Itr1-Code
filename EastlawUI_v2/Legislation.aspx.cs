...
namespace EastlawUI_v2
{
    public partial class Legislation : System.Web.UI.Page
    {
        ...
        void BindLegislationTitles()
        {
            try
            {
                DataTable dt = new DataTable();
                //dt = objstate.GetActiveStatutesLessInfo();
                //radAutoCompleteTitle.DataTextField = "Title";
                //radAutoCompleteTitle.DataSource = dt;
                //radAutoCompleteTitle.DataBind();
        ...
        protected void btnSearchFreetext_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                //    string cri1 = "Where A.IsDeleted=0 and A.Active=1";
                //    string cri2 = "Where A.IsDeleted=0 and A.Active=1";
