...
namespace EastlawUI_v2
{
    public partial class PracticeAreaSearchResult : System.Web.UI.Page
    {
        ...
        void BreadCrumb()
        {
            try
            {
                hypLnkItems.NavigateUrl = "/Practice-Area/" + Request.QueryString["trans"].ToString() + "?param=" + Request.QueryString["param"].ToString() + "&trans=" + Request.QueryString["trans"].ToString() + "";
                hypLnkItems.Text = Request.QueryString["trans"].ToString().Replace("-", "");
                lblCurCrumb.Text = HttpContext.Current.Items["PAkeywordtxt"].ToString();
            }
            catch { }
        }
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int a = 0; a < dt.Rows.Count; a++)
                        {
                            if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                            {
                                ...
                                // OtherCont = OtherCont + HighlightText(HighlightTextWithin(dt.Rows[a]["ShortDes"].ToString().Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", "")));
                                if (KeyPTag == 1)
                                    dt.Rows[a]["Desc"] = HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keywordP1.ToString()).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 200)), keywordP1);
                                else
                                    dt.Rows[a]["Desc"] = HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keyword.ToString()).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 200)), keyword);
                    ...
                    for (int a = 0; a < dt.Rows.Count; a++)
                    {
                        if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                        {
                            ...
                            if (KeyPTag == 1)
                                ...
                                dt.Rows[a]["Desc"] = HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keywordP2.ToString()).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 200)), keywordP2);
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int a = 0; a < dt.Rows.Count; a++)
                        {
                            if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                            {
                                ...
                                dt.Rows[a]["Desc"] =  HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), HttpContext.Current.Items["keywordtxt"].ToString()).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 100)));
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int a = 0; a < dt.Rows.Count; a++)
                        {
                            if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                            {
                                ...
                                if (KeyPTag == 1)
                                    dt.Rows[a]["Desc"] =  HighlightText(HighlightTextWithin(CommonClass.GetWords(CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keywordP1).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 100)));
                                else
                                    dt.Rows[a]["Desc"] =  HighlightText(HighlightTextWithin(CommonClass.GetWords(CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keyword).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 100)));
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int a = 0; a < dt.Rows.Count; a++)
                        {
                            if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                            {
                                ...
                                if (KeyPTag == 1)
                                    dt.Rows[a]["Desc"] = HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keywordP1).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 100)));
                                else
                                    dt.Rows[a]["Desc"] =  HighlightText(HighlightTextWithin(EastlawUI_v2.CommonClass.GetWords(EastlawUI_v2.CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keyword).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 100)));
                            ...
                            {
                                dt.Rows[a]["Title"] = EastlawUI_v2.CommonClass.MakeFirstCap(dt.Rows[a]["Appeallant"].ToString());
                                dt.Rows[a]["Link"] = "/statutes/" + clsUtilities.RemoveSpecialCharacter(EastlawUI_v2.CommonClass.MakeFirstCap(CommonClass.GetWords(dt.Rows[a]["Appeallant"].ToString(), 3).ToString())).Replace(" ", "-") + "." + EncryptDecryptHelper.Encrypt(dt.Rows[a]["ID"].ToString());
                                string OtherCont = "Index:" + dt.Rows[a]["Citation"].ToString() + "<br/>";
                                OtherCont = OtherCont + dt.Rows[a]["JDate"].ToString();
                                if (!string.IsNullOrEmpty(dt.Rows[a]["Respondent"].ToString()))
                                    OtherCont = OtherCont + " | " + dt.Rows[a]["Respondent"].ToString() + "<br />";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (int a = 0; a < dt.Rows.Count; a++)
                        {
                            if (dt.Rows[a]["ResultType"].ToString() == "Cases")
                            {
                                ...
                                if (KeyPTag == 1)
                                    dt.Rows[a]["Desc"] = HighlightText(HighlightTextWithin(CommonClass.GetWords(CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keywordP1).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 200)));
                                else
                                    dt.Rows[a]["Desc"] =  HighlightText(HighlightTextWithin(CommonClass.GetWords(CommonClass.GetShortDesc(dt.Rows[a]["Judgment"].ToString(), keyword).Replace("</p>", "").Replace("<p>", "").Replace("<br>", "").Replace("<b>", "").Replace("</b>", ""), 200)));
