<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatutesIndexDetails_Public.aspx.cs" Inherits="EastlawUI_v2.StatutesIndexDetails_Public" 
     MasterPageFile="~/Withoutlogin.Master"%>


<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<asp:Content ID="Content2" runat="server" contentplaceholderid="cntPlc">
...
<ul class="bc">
    ...
    <%
        ...
        if (dt != null)
        {
            if(dt.Rows.Count > 0)
            {
                if (dt.Rows[0]["PublicDisplay"].ToString() != "1")
                        Response.Redirect("/");
