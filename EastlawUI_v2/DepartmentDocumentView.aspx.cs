            ...
            try
            {
                ...
                if (dt != null)
                {
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        lblCurCrumb1Link.HRef = "/departments/" + dt.Rows[0]["ParentDept"].ToString().Replace(" ", "-").ToLower() + "." + EncryptDecryptHelper.Encrypt(dt.Rows[0]["ParentDeptID"].ToString());


                        //lblCurCrumb2.Text = dt.Rows[0]["ChildDept"].ToString();
                        //lblCurCrumb2Link.HRef = "/departments/" + dt.Rows[0]["ChildDept"].ToString().Replace(" ", "-").ToLower() + "." + EncryptDecryptHelper.Encrypt(dt.Rows[0]["ChildDeptID"].ToString());


                        lblCurCrumb3.Text = dt.Rows[0]["DeptName"].ToString();
                        lblCurCrumb3Link.HRef = "/departments/" + dt.Rows[0]["DeptName"].ToString().Replace(" ", "-").ToLower() + "." + EncryptDecryptHelper.Encrypt(dt.Rows[0]["DeptID"].ToString());
