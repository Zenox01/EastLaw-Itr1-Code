...
using System.Text.RegularExpressions;
    ...
    public static class clsUtilities
    {
        ...
        public static void comboFill(DropDownList ddl, DataTable dt)
        {
            ...
            {
                ddl.Items.Add(new ListItem(row[1].ToString().Trim(), row[0].ToString().Trim()));
            }
        ...
        public static void comboFill(DropDownList ddl, DataTable dt, String text, String value)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ddl.Items.Add(new ListItem(row[text].ToString().Trim(), row[value].ToString().Trim()));
            }
        ...
        //Public Shared Function GetMenuTabIndex(formId As String) As String
